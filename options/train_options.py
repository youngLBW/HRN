...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # dataset parameters
        # for train
        parser.add_argument('--data_list', type=str, default='./', help='data list path')
        ...
        parser.add_argument('--use_aug', type=util_.str2bool, nargs='?', const=True, default=True, help='whether use data augmentation')
